                ...
                <div className={styles.formBox}>
                    ...
                    <div className={styles.field}>
                        ...
                        <div className={styles.inputWrapper}>
                            <input className={`${styles.input} ${styles.inputWithIcon}`} type="password" id="senha" placeholder="••••••••" />
                            <span id="olho" className={`${styles.inputIcon} material-symbols-rounded`} onClick={toggleSenha}>
                                visibility
                            </span>
                        </div>
                    ...
                    <div className={styles.registerLink}>
                        Ainda não possui conta? <a href="/register">Clique aqui</a>
                    </div>
